...
interface TaskFormProps {
  onSubmit: (taskName: string, dateTime: string) => void;
  onBack: () => void;
}

export function TaskForm({ onSubmit, onBack }: TaskFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit(taskName.trim(), dateTime);
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      ...
      <h2 className="text-gray-900 mb-6">Add New Task</h2>
